import { KeyRevealModal } from "@/app/auth/KeyRevealModal";
...
export default function SettingsScreen() {
  ...
  return (
    <>
            ...
            <SettingsRow
              ...
              onPress={
                row.label === "Form Configuration"
                  ...
                  : row.label === "Revoke Encryption Key"
                    ? () => setIsRevokeKeyVisible(true)
                    : row.onPress
              }
            />
          ))}
      ...
      <KeyRevealModal
        visible={isRevokeKeyVisible}
        mode="revoke"
        onSuccess={() => {
          setIsRevokeKeyVisible(false);
          void queryClient.invalidateQueries({ queryKey: ["user-keys"] });
        }}
        onClose={() => setIsRevokeKeyVisible(false)}
      />
    </>
  );
}
